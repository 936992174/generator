package com.peas.cloud.cache;

import com.googlecode.gentyref.GenericTypeReflector;
import com.peas.cloud.util.SerializerUtil;
...
public abstract class AbstractCache<V extends Serializable> implements CacheInvalidListener{
    ...
    protected void setListOperations(String key, V value) {
        redisTemplate.opsForList().rightPush(key, value);
    }

    protected void delListOperations(String key, V value) {
