...
//        os.write(buf, 0, c);
    ...
    public static void main(String[] args) throws IOException {
        SSHTool tool = new SSHTool("139.129.100.99", "root", "yjfc415058**", StandardCharsets.UTF_8);
        boolean login = tool.login();
        System.out.println(login);
        StringBuilder exec = tool.exec("bash /home/appdev/restart-app-server.sh");
